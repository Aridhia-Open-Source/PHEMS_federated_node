...
class Task(db.Model, BaseModel):
    ...
    def validate(cls, data:dict):
        ...
        is_from_controller = data.pop("settings.task_controller", False)
        ...
        if not data.get("inputs", {}):
            data["inputs"] = {"inputs.csv": settings.task_pod_inputs_path}
    ...
    def needs_crd(self):
        return ((not self.is_from_controller) and settings.task_controller)
    ...
    def create_controller_crd(self):
        ...
        If the settings.task_controller is not set, do nothing
        """
