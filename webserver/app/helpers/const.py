...
DB_LIVENESS_ENABLED = os.getenv("DB_LIVENESS_ENABLED", "true").lower() == "true"
DB_LIVENESS_RETRIES = os.getenv("DB_LIVENESS_RETRIES", "5")
DB_LIVENESS_BACKOFF = os.getenv("DB_LIVENESS_BACKOFF", "30")
DB_LIVENESS_TIMEOUT = os.getenv("DB_LIVENESS_TIMEOUT", "30")
